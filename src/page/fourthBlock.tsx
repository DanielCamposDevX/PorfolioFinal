...
export function FourthBlock() {
    ...
    return (
        <div className="p-6 flex flex-col h-screen bg-black/90">
            <div className="flex flex-1 justify-around items-center leading-relaxed">
                <Icons />
                <div className="w-1/2">
                    ...
                    <p className="text-sm mb-8">Além de reforçar meis conhecimentos aprendi várias coisas novas e me preparei mais ainda para o mercado de trabalho</p>
